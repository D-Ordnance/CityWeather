...
@Composable
fun SavedCityContentScreen(modifier: Modifier = Modifier, context: Context, viewModel: CityWeatherViewModel) {
    val weatherState = viewModel.savedCityWeatherState.observeAsState(initial = UIState.Loading)
