...
@Composable
fun SearchContentScreen(modifier: Modifier = Modifier, context: Context, viewModel: CityWeatherViewModel){
    val weatherState = viewModel.weatherState.observeAsState(initial = UIState.Loading)
